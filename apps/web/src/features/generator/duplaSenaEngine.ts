// Dados estatisticos e mapeamento de filtros da tela de geracao de jogos da Dupla Sena.
// A geracao acontece no backend (POST /gerador/dupla-sena/gerar); este modulo guarda os
// dados historicos exibidos na UI e converte as escolhas do usuario no payload de filtros.
// A Dupla Sena usa cartela 01-50, aposta minima de 6 dezenas e nao tem os conceitos de moldura
