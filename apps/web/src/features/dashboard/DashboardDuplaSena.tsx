...
// Painel estatistico da Dupla Sena: consome o resumo consolidado do backend e monta os cartoes.
export function DashboardDuplaSena() {
        ...
        <div className="dash-body">
          <div className="dash-content">
            ...
            <section className="dash-card">
              ...
              <div className="dash-bars dash-bars--dupla-sena" role="img" aria-label="Frequência das 50 dezenas">
...
// Monta os blocos do cartao de filtros da Dupla Sena a partir das categorias cruas do backend.
// A Dupla Sena nao tem moldura nem grade densa; por isso esses blocos sao omitidos.
