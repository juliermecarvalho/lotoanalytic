    ...
    private static void ConfigureLotteryMode(ModelBuilder modelBuilder, DateTimeOffset createdAt)
    {
        modelBuilder.Entity<LotteryMode>(entity =>
        {
            ...
            entity.HasData(
                ...
                new LotteryMode { Id = MaisMilionariaModeId, Code = "maismilionaria", Name = "+Milionaria", CaixaGameType = "MAIS_MILIONARIA", CaixaGameNumber = 33, MainNumbersCount = 6, HasTrevos = true, SimpleBetPrice = 6.00m, Active = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new LotteryMode { Id = LotomaniaModeId, Code = "lotomania", Name = "Lotomania", CaixaGameType = "LOTOMANIA", CaixaGameNumber = 7, MainNumbersCount = 20, SimpleBetPrice = 3.00m, Active = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                ...
                new LotteryMode { Id = DuplaSenaModeId, Code = "dupla_sena", Name = "Dupla Sena", CaixaGameType = "DUPLA_SENA", CaixaGameNumber = 12, MainNumbersCount = 6, SecondDrawNumbersCount = 6, SimpleBetPrice = 3.00m, Active = true, CreatedAt = createdAt, UpdatedAt = createdAt },
